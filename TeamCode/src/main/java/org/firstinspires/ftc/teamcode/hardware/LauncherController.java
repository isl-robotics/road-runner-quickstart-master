...
public class LauncherController {
    ...
    public LauncherController(DcMotorEx launcherMotor1, DcMotorEx launcherMotor2, DcMotor gateMotor){
        ...
        launcherMotor1.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(250,0.3,0.5,6.5));
        launcherMotor2.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(250,0.3,0.5,6.5));
    }
