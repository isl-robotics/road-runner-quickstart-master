...
public class RedAuto2 extends AutoInit{
    ...
    public void extraInit(){
        ...
        traj5 = traj4.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(mmToIn(400), -30), -Math.toRadians(90))
        //.waitSeconds(1)
        ;

        traj6 = traj5.endTrajectory().fresh()
                .strafeToConstantHeading(new Vector2d(mmToIn(400),-55),new TranslationalVelConstraint(25))
        //      .waitSeconds(0.2)
        ;
        ...
        traj8 = traj7.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(mmToIn(1300), -20), -Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(mmToIn(1300), -45), -Math.toRadians(90))
