...
public abstract class Init extends LinearOpMode {
    ...
    private void initLauncherControlPoints(){
        ...
        launchingControlPoints.add(190, 1560);
        launchingControlPoints.add(200, 1560);
        launchingControlPoints.add(210, 1580);
        launchingControlPoints.add(220, 1580);
        launchingControlPoints.add(230, 1580);
        launchingControlPoints.add(240, 1600);
        launchingControlPoints.add(250, 1600);
        launchingControlPoints.add(260, 1600);
        launchingControlPoints.add(270, 1620);
        launchingControlPoints.add(280, 1640);
        launchingControlPoints.add(290, 1640);
        launchingControlPoints.add(300, 1660);
        launchingControlPoints.add(310, 1680);
        launchingControlPoints.add(320, 1700);
        launchingControlPoints.add(330, 1700);
        launchingControlPoints.add(340, 1740);
        launchingControlPoints.add(350, 1740);
        launchingControlPoints.add(360, 1740);
        launchingControlPoints.add(370, 1740);
        launchingControlPoints.add(380, 1740);
        launchingControlPoints.add(500, 1740);
